...
const QUOTE_URLS = [
  'https://raw.githubusercontent.com/DavidXTech/Islamic-Database/main/text/random_quotes.txt',
  'https://raw.githubusercontent.com/DavidXTech/Islamic-Database/main/text/motivational_quotes.txt',
  'https://raw.githubusercontent.com/DavidXTech/Islamic-Database/main/text/pickup_quotes.txt'
];
...
async function fetchQuotes() {
  try {
    ...
    return cachedQuotes.length > 0 ? cachedQuotes : ['💎 By COLLY MD - Your WhatsApp Bot'];
  }
}

function getRandomQuote(quotes: string[]) {
  if (!quotes || quotes.length === 0) return '💎 By COLLY MD';
